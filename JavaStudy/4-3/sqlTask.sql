...
-- [回答]
	...
	group by store_code having avg(quantity) > (select avg(quantity) from stock_table
				  	  group by store_code having (store_code) = 'EA01') 
